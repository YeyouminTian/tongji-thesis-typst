...
> 同时支持 **GB/T 7714—2015** 和 **GB/T 7714—2025**。2025 版于 2025-12-02 发布，
> 2026-07-01 实施。
...
// 2025 Numeric: [1]260, [2], [3]Table 2
// 2025 Author-date: （Smith，2020a）260；（Smith，2020b）；（Jones，2019）Table 2
...
2025 版不是一次简单的标点替换。它新增或独立规定了会议录、学位论文、报告、标准、网站/网页、
档案、地图、数据集、预印本等类型，改用“永久标识符”，重构电子资源和析出文献规则，并调整
正文标引与参考文献表编制要求。

完整的 15 类技术变化及 BibTeX 迁移建议见
[GB/T 7714—2025 支持与迁移说明](../../docs/gb-t-7714-2025.md)。
...
除网站、网页和 2025 版预印本等天然在线类型外，URL/DOI 不会自动推断 `/OL`。引用电子版图书、
期刊、报告等时请显式填写 `medium = {OL}`。
