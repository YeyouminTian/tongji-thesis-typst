...
#let declaration-statements(info) = {
  ...
  page-style(numbering: "1", header: none)[
    ...
    #v(0.5fr)
    #declaration-body[
      本人郑重声明：所呈交的学位论文#underline(evade: false, stroke: 1pt, offset: 3pt)[#text(weight: "bold", size: 1em)[《#get(info, "title")》]]，是本人在导师指导下，独立进行研究工作所取得的成果。除文中已经注明引用的内容外，本学位论文的研究成果不包含任何他人创作的、已公开发表或者没有公开发表的作品的内容。对本论文所涉及的研究工作做出贡献的其他个人和集体，均已在文中以明确方式标明。本学位论文原创性声明的法律责任由本人承担。
    ]
