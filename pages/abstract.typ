...
#let abstract-cn(keywords: (), body) = {
  page-style(numbering: "I", header: [摘要], top-margin: 3.75cm, header-ascent: 1.22cm, footer-descent: 0.69cm)[
...
#let abstract-en(keywords: (), body) = {
  page-style(numbering: "I", header: [Abstract], header-font: fonts.en, top-margin: 3.75cm, header-ascent: 1.22cm, footer-descent: 0.69cm)[
